	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Blitz Brand Colors - Bold & Energetic
				blitz: {
					primary: 'hsl(var(--blitz-primary))',      // Bold Orange-Red
					secondary: 'hsl(var(--blitz-secondary))',  // Vibrant Pink
					accent: 'hsl(var(--blitz-accent))',        // Electric Purple
			...
			backgroundImage: {
				...
				'blitz-gradient': 'linear-gradient(135deg, hsl(var(--blitz-primary)) 0%, hsl(var(--blitz-secondary)) 100%)',
				'blitz-gradient-reverse': 'linear-gradient(135deg, hsl(var(--blitz-secondary)) 0%, hsl(var(--blitz-accent)) 100%)',
			},
			keyframes: {
				'accordion-down': {
					from: { height: '0' },
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--blitz-primary) / 0.3)' },
					'50%': { boxShadow: '0 0 30px hsl(var(--blitz-primary) / 0.6)' }
				},
				'gradient-shift': {
