...
const SwipeActions: React.FC<SwipeActionsProps> = ({ 
  ...
  <div className="flex justify-between items-center mt-6 px-6 py-3 glassmorphism rounded-full w-64 mx-auto">
    ...
    >
      <div className="w-10 h-10 flex items-center justify-center bg-blitz-gray/60 rounded-full hover:bg-blitz-gray/80 transition-all">
    ...
    <button 
      ...
      className="flex flex-col items-center cursor-pointer focus:outline-none transition-transform active:scale-95"
    >
      <div className="w-10 h-10 flex items-center justify-center bg-blitz-pink rounded-full hover:bg-blitz-pink/90 transition-all">
